...
def salary_config_create(request):
   ...
   if request.method == 'POST':
       ...
       if all([config_form.is_valid(), manager_form.is_valid(), 
           ...
           return redirect('salary_config_detail', pk=config.pk)
   else:
   ...
   return render(request, 'salary_config/config_create.html', context)
...
def salary_config_edit(request, pk):
   ...
   return render(request, 'salary_config/config_edit.html', context)
...
def salary_assignment_create(request):
   ...
   if request.method == 'POST':
       ...
       if form.is_valid():
           ...
           return redirect('salary_assignments')
   else:
...
def salary_adjustment_create(request):
   ...
   if request.method == 'POST':
       ...
       if form.is_valid():
           ...
           return redirect('salary_adjustments')
   else:
...
def salary_config_copy(request):
   ...
   if request.method == 'POST':
       ...
       if form.is_valid():
           ...
           return redirect('salary_config_detail', pk=new_config.pk)
   else:
